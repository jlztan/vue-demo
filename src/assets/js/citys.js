let provinces = [
  ...
  },
  {
    ...
    city: [
      {
        name: '九龙',
        districtAndCounty: ['观塘区', '黄大仙区', '九龙城区']
      },
      {
        name: '香港岛',
        districtAndCounty: ['东区', '南区', '湾仔区', '中西区']
      },
      {
        name: '新界',
        districtAndCounty: ['北区', '大埔区', '葵青区']
      }
    ]
  },
  {
    ...
    city: [
      {
        name: '澳门半岛',
        districtAndCounty: ['大堂区', '风顺堂区', '花地玛唐区']
      },
      {
        name: '离岛',
        districtAndCounty: ['嘉模堂区', '路氹填海区', '圣方济各堂区']
      }
    ]
  },
  {
